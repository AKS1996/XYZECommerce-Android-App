...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LoginActivity.facebookloggedIn = sharedPreferences.getBoolean(Constants.LoggedIn, false);
    ...
    protected void onDestroy() {
        ...
        editor.putBoolean(Constants.LoggedIn, LoginActivity.facebookloggedIn);
        editor.apply();
    }
}
